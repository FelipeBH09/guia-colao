      ...
      <section className="py-20 bg-gradient-gold text-primary">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto opacity-90 mb-8">
            El reconocimiento Greca COLAO es el máximo reconocimiento otorgado por la Guía COLAO a cafeterías excepcionales con calificaciones de 4.5 a 5 estrellas y evaluado por nuestros inspectores autorizados
          </p>
